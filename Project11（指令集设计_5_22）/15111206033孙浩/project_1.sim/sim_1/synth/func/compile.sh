...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L unisims_ver -L secureip --snapshot mips_tb_func_synth --prj C:/Users/Administrator/Desktop/project_1/project_1.sim/sim_1/synth/func/mips_tb.prj   xil_defaultlib.mips_tb   xil_defaultlib.glbl
